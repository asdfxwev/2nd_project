...
export default function Menu() {
    ...
    return (
        <>
            <div className={`h_main_container ${smallTopMenu ? 'smallHeadMenu' : ''}`}>
                <div className="h_menu_container">
                    <div className="h_menu" style={{color:'white'}} onClick={() => MenuToggle('headerMenu')}><NavLink to='/'>건프라</NavLink></div>
                    <div className="h_menu" style={{color:'white'}} onClick={() => MenuToggle('headerMenu1')}><NavLink to='/'>애니프라</NavLink></div>
                    <div className="h_menu" style={{color:'white'}} onClick={() => MenuToggle('headerMenu2')}><NavLink to='/'>피규어</NavLink></div>
                    <div className="h_menu" style={{color:'white'}} onClick={() => MenuToggle('etc')}><NavLink to='/'>기타</NavLink></div>
                </div>
                ...
                <div className="h_right_container">
                    ...
                    <div className="h_right h_mypage"><a href="/"><FontAwesomeIcon icon={faUser} /> 마이페이지</a></div>
                    <div className="h_right h_shopping"><a href="/"><FontAwesomeIcon icon={faShoppingCart} /> 장바구니</a></div>
                    <div className="h_right h_search" onClick={() => MenuToggle('headerSearch')}><NavLink to='/'><FontAwesomeIcon icon={faSearch} /> 검색</NavLink></div>
                </div>
            </div>
            ...
            {visibleMenu === 'headerMenu' && <HeaderMenu data={HeaderMenuData.headerMenu} />}
            {visibleMenu === 'headerMenu1' && <HeaderMenu data={HeaderMenuData.headerMenu1} />}
            {visibleMenu === 'headerMenu2' && <HeaderMenu data={HeaderMenuData.headerMenu2} />}
            {visibleMenu === 'etc' && <HeaderMenu data={HeaderMenuData.etc} />}
            {visibleMenu === 'headerSearch' && <HeaderSearch />}
        </>
    );
}
